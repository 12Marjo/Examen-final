...
##Hay 8variantes de las cuañes se presentan los tipos esta informacion permite la sintesis de un producto génico  funcional que le permite producir productos finales, proteinas o arn no codificante para finalmente afectar a un fenotipo,se muestra el gen de interes con la parte de interes de allí la importancia del codigo, Genskew es una aplicación para calcular y trazar datos de sesgo de nucleótidos.
...
## utilizo el gen "GATA3" por que me ayuda a comparar con el resto de genes en los diferentes datasets 
